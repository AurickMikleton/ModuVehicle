...
class GasEngine : public MoVeEngine {
private:
	GDCLASS(GasEngine, MoVeEngine);
	//properties
	//engine
...
public:
	double engine_torque(double rpm) override;
	void update_rpm(double delta) override;
	void set_reflected_load(double v) override;

	// Size
	void set_bore(double v);
	double get_bore() const;
	void set_stroke(double v);
	double get_stroke() const;
	void set_cylinders(int v);
	int get_cylinders() const;

	// Torque curve
	void set_peak_rpm_base(double v);
	double get_peak_rpm_base() const;
	void set_sigma_left(double v);
	double get_sigma_left() const;
	void set_sigma_right(double v);
	double get_sigma_right() const;

	// Turbo
	void set_wastegate_bar(double v);
	double get_wastegate_bar() const;
	void set_spool_rpm(double v);
	double get_spool_rpm() const;
	void set_spool_k(double v);
	double get_spool_k() const;
	...
	//misc
	void set_friction_coeff(double v);
	double get_friction_coeff() const;
	void set_current_rpm(double v);
	double get_current_rpm() const override;
};
