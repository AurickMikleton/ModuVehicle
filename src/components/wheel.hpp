...
public:
	...
	void set_ground_speed(float v_mps);
	float get_ground_speed() const; // forward speed at contact (m/s)
	...
	void set_is_powered(bool v);
	bool get_is_powered() const;
	void set_spring_strength(float v);
	float get_spring_strength() const;
	void set_spring_damping(float v);
	float get_spring_damping() const;
	void set_resting_distnace(float v);
	float get_resting_distnace() const;
	void set_wheel_radius(float v);
